...
module.exports = function(io) {
    ...
    io.on('connection', (socket) => {
        ...
        socket.on('initialize-dashboard', function(username, callback) {
            ...
            //let socketNamespace = `org-limits-update:${username}`;
            let socketNamespace = profile.user_id;
            ...
            //NOTE: Invoking this callback here will not stop execution in this method.
